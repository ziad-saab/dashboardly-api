...
const BOOKMARKS_FIELDS = ['id', 'boardId', 'title', 'url', 'createdAt', 'updatedAt'];
const BOOKMARKS_WRITE_FIELDS = ['boardId', 'title', 'url'];
...
class DashboardlyDataLoader {
  ...
  updateBookmark(bookmarkId, bookmarkData) {
    // const errors = validate.updateBookmark(bookmarkData);
    // if (errors) {
    //   return Promise.reject({ errors: errors });
    // }
