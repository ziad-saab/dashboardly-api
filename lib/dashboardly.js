...
class DashboardlyDataLoader {
  ...
  createBookmark(bookmarkData) {
    ...
    let boardOwner = this.getUserFromBoard(bookmarkData.boardId);
    // Check if the owner can actually create a bookmark in its board
    if (boardOwner) {
      return this.query(
        knex
    ...
    return Promise.reject({errors: 'Invalid user for creating bookmark under this board'})
  }
